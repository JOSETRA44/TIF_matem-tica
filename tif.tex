...
\item Reportes de transferencias mineras y producción del Ministerio de Energía y Minas (MINEM).
\item Proyecciones macroeconómicas del BCRP y registros del Portal de Transparencia Económica (MEF).
\end{itemize}
...
\begin{itemize}
\item Recopilación de las Cuentas de Oferta y Utilización (COU): Obtención de las tablas oficiales del INEI actualizadas al periodo 2024, utilizando el Valor Agregado Bruto (VAB) regional para ajustar los niveles de producción.
\item Regionalización mediante el método FLQ: Generación de la Matriz Insumo-Producto para Arequipa aplicando el Coeficiente de Ubicación de Flegg (FLQ), técnica que permite ajustar los coeficientes técnicos nacionales considerando el tamaño relativo de la economía regional.
\item Cálculo de la matriz de requerimientos totales: Determinación de la Matriz Inversa de Leontief para hallar el vector de impacto máximo, cuantificando cuánto debe crecer la producción total para satisfacer un shock en la demanda minera.
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
\item La aplicación del modelo Insumo-Producto permitió cuantificar el impacto económico de la minería en Arequipa, revelando un multiplicador de producción total de 1.080 que evidencia débiles encadenamientos con otros sectores de la economía regional. Este bajo multiplicador subraya la necesidad de políticas que fortalezcan los vínculos intersectoriales del sector minero.
