...
El multiplicador de producción total de 1.080 para el sector minero revela un efecto multiplicador notablemente bajo en comparación con estudios empíricos para economías con características similares. Este valor indica que el impacto de la minería se concentra principalmente dentro del propio sector, con escasos eslabonamientos hacia el resto de la economía regional. Los resultados evidencian un débil vínculo con los sectores de Servicios y de Industria/Construcción, contradiciendo el modelo de desarrollo esperado. Sin embargo, el multiplicador hacia la agricultura (0.002) sugiere una desconexión casi total, lo que podría ser una fuente de conflicto por el uso de recursos como el agua y la tierra, un punto a menudo señalado en estudios de caso regionales como el de Quispe (2020).
